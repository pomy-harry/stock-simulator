...
import classes from './StockShowInfoDetailOne.module.css'

const StockShowInfoDetailOne = (props) => {
  return (
    <>
        ...
        <div className={classes.stock__box}>
            ...
            <div className={classes.row}>
                <span>수익률 : </span>  
                <span className={(props.totalNowPrice - props.totalBuyPrice) > 0 ? classes.rate__red : classes.rate__blue}>
...
export default StockShowInfoDetailOne